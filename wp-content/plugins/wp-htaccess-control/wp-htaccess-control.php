...
Description: Interface to customize the permalinks (author, category, archives and pagination) and the .htaccess file generated by WordPress.
Version: 3.3
*/
	...
	class WPhtc {
		...
		function configure_menu(){
			if(current_user_can("administrator")){
				$page=add_submenu_page("options-general.php",".htaccess", ".htaccess", 6, __FILE__, array('WPhtc','page'));
