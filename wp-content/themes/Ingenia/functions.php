...
/**
 * Here we salute the user. Inspired by Hello Dolly by Ma.tt.
 */
function fellow_user_lyric() {
...
function fellow_user() {
	$chosen = fellow_user_lyric();
	echo $chosen . " ";
}
...
function show_top_must_read() {
	...
	if ( $top_must_read_query->have_posts() ) {
		while ( $top_must_read_query->have_posts() ) {
			...
			$ingenia_logo = "<img src='/wp-content/themes/Ingenia/images/ingenia.svg'>";
