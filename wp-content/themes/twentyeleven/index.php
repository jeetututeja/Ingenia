...
get_header(); ?>
		<div id= "galaxy">
			...
			<?php
			$big_story_1_query = new WP_Query( array(
				'post_type' => 'post',
				'posts_per_page' => 1,
				'tax_query' => array(
					array(
			...
			if ( $big_story_1_query->have_posts() ): ?>
				<?php while ( $big_story_1_query->have_posts() ) : $big_story_1_query->the_post(); ?>
			...
			<?php endif; ?>
			<?php
			$big_story_2_query = new WP_Query( array(
				'post_type' => 'post',
				'posts_per_page' => 1,
				'tax_query' => array(
					array(
			...
			// Display the custom loop
			if ( $big_story_2_query->have_posts() ): ?>
				<?php while ( $big_story_2_query->have_posts() ) : $big_story_2_query->the_post(); ?>
